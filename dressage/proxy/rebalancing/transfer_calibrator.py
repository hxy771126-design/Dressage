...
from .cache_hit_estimator import CacheSource
...
class TransferCalibrator:
    ...
    def observe(
        ...
        *,
        ...
        result_key = (source_node, target_node, link_type, int(payload_bytes))
        self._results[result_key] = CalibrationSample(
            elapsed_seconds_p75=elapsed_seconds_p75,
            bandwidth_bytes_per_second_p25=bandwidth_bytes_per_second_p25,
